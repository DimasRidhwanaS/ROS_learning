...
(cl:in-package learn_robot1_pkg-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <person_data>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'person_data)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name learn_robot1_pkg-msg:<person_data> is deprecated: use learn_robot1_pkg-msg:person_data instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <person_data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader learn_robot1_pkg-msg:name-val is deprecated.  Use learn_robot1_pkg-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <person_data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader learn_robot1_pkg-msg:age-val is deprecated.  Use learn_robot1_pkg-msg:age instead.")
  (age m))

(cl:ensure-generic-function 'color-val :lambda-list '(m))
(cl:defmethod color-val ((m <person_data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader learn_robot1_pkg-msg:color-val is deprecated.  Use learn_robot1_pkg-msg:color instead.")
  (color m))
